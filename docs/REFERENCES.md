...
# dng2hdr2jpg.py | Python | 4082L | 128 symbols | 19 imports | 86 comments
...
### fn `def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)` `priv` (L652-680)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L681-726)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L727-740)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L741-772)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L773-803)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L804-821)
...
### fn `def _parse_auto_zero_option(auto_zero_raw)` `priv` (L822-839)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L840-857)
...
### fn `def _clamp_ev_to_supported(ev_candidate, ev_values)` `priv` (L858-871)
...
### fn `def _quantize_ev_to_supported(ev_value, ev_values)` `priv` (L872-893)
...
### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L894-953)
...
### fn `def _percentile(percentile_value)` `priv` (L928-938)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L954-973)
...
### fn `def _optimize_auto_zero(auto_ev_inputs)` `priv` (L974-992)
- @brief Compute optimal EV-zero center from normalized median luminance.
- @details Solves `ev_zero=log2(median_target/p_median)`, clamps result to `[-BASE_MAX,+BASE_MAX]` where `BASE_MAX=max(ev_values)`, and quantizes to nearest quarter-step represented by `ev_values` with sign preservation.
...
### fn `def _optimize_adaptive_ev_delta(auto_ev_inputs)` `priv` (L993-1022)
...
### fn `def _compute_auto_ev_value_from_stats(` `priv` (L1023-1028)

### fn `def _compute_auto_ev_value(raw_handle, supported_ev_values=None, ev_zero=0.0)` `priv` (L1056-1083)
...
### fn `def _resolve_ev_zero(` `priv` (L1084-1090)

### fn `def _resolve_ev_value(` `priv` (L1134-1140)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L1188-1208)
...
### fn `def _parse_gamma_option(gamma_raw)` `priv` (L1209-1245)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L1246-1269)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L1270-1286)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L1287-1309)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L1310-1332)
...
### fn `def _parse_auto_brightness_tile_grid_size_option(option_raw)` `priv` (L1333-1356)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1357-1381)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L1382-1404)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1405-1430)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L1431-1501)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L1502-1608)
...
### fn `def _parse_auto_adjust_mode_option(auto_adjust_raw)` `priv` (L1609-1632)
...
### fn `def _resolve_default_postprocess(enable_luminance, luminance_tmo)` `priv` (L1633-1675)
...
### fn `def _parse_run_options(args)` `priv` (L1676-1875)
...
### fn `def _load_image_dependencies()` `priv` (L2262-2300)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L2301-2331)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L2332-2389)
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L2390-2421)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L2422-2444)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L2445-2446)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L2475-2517)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L2518-2651)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L2652-2657)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L2706-2720)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L2721-2737)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L2738-2756)
...
### fn `def _write_bracket_images(` `priv` (L2757-2758)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L2795-2820)
...
### fn `def _run_enfuse(bracket_paths, merged_tiff)` `priv` (L2821-2841)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L2842-2843)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L2887-2899)
...
### fn `def _resolve_imagemagick_command()` `priv` (L2900-2917)
...
### fn `def _resolve_auto_adjust_opencv_dependencies()` `priv` (L2918-2942)
...
### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L2943-2987)
...
### fn `def _clip_histogram_autolevel_channel(` `priv` (L2988-2989)

### fn `def _apply_mean_gamma_correction_channel(` `priv` (L3021-3022)
...
### fn `def _apply_auto_brightness_rgb_uint8(` `priv` (L3049-3050)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L3114-3115)
...
### fn `def _clamp01(np_module, values)` `priv` (L3196-3209)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L3210-3232)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L3233-3266)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L3267-3297)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L3298-3338)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L3339-3340)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L3389-3411)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L3412-3436)
...
### fn `def logistic(z_values)` (L3427-3429)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L3437-3454)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L3455-3478)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L3479-3502)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L3503-3524)
...
### fn `def _apply_validated_auto_adjust_pipeline_opencv(` `priv` (L3525-3526)

### fn `def _load_piexif_dependency()` `priv` (L3605-3622)
...
### fn `def _encode_jpg(` `priv` (L3623-3635)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L3815-3843)
...
### fn `def _is_supported_runtime_os()` `priv` (L3844-3863)
...
|`_derive_supported_ev_values`|fn|priv|652-680|def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)|
|`_detect_dng_bits_per_color`|fn|priv|681-726|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|727-740|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|741-772|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|773-803|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|804-821|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_auto_zero_option`|fn|priv|822-839|def _parse_auto_zero_option(auto_zero_raw)|
|`_parse_auto_brightness_option`|fn|priv|840-857|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_clamp_ev_to_supported`|fn|priv|858-871|def _clamp_ev_to_supported(ev_candidate, ev_values)|
|`_quantize_ev_to_supported`|fn|priv|872-893|def _quantize_ev_to_supported(ev_value, ev_values)|
|`_extract_normalized_preview_luminance_stats`|fn|priv|894-953|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|928-938|def _percentile(percentile_value)|
|`_coerce_positive_luminance`|fn|priv|954-973|def _coerce_positive_luminance(value, fallback)|
|`_optimize_auto_zero`|fn|priv|974-992|def _optimize_auto_zero(auto_ev_inputs)|
|`_optimize_adaptive_ev_delta`|fn|priv|993-1022|def _optimize_adaptive_ev_delta(auto_ev_inputs)|
|`_compute_auto_ev_value_from_stats`|fn|priv|1023-1028|def _compute_auto_ev_value_from_stats(|
|`_compute_auto_ev_value`|fn|priv|1056-1083|def _compute_auto_ev_value(raw_handle, supported_ev_value...|
|`_resolve_ev_zero`|fn|priv|1084-1090|def _resolve_ev_zero(|
|`_resolve_ev_value`|fn|priv|1134-1140|def _resolve_ev_value(|
|`_parse_luminance_text_option`|fn|priv|1188-1208|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_gamma_option`|fn|priv|1209-1245|def _parse_gamma_option(gamma_raw)|
|`_parse_positive_float_option`|fn|priv|1246-1269|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|1270-1286|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|1287-1309|def _parse_jpg_compression_option(compression_raw)|
|`_parse_positive_int_option`|fn|priv|1310-1332|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_auto_brightness_tile_grid_size_option`|fn|priv|1333-1356|def _parse_auto_brightness_tile_grid_size_option(option_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|1357-1381|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|1382-1404|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|1405-1430|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_auto_brightness_options`|fn|priv|1431-1501|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_adjust_options`|fn|priv|1502-1608|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_auto_adjust_mode_option`|fn|priv|1609-1632|def _parse_auto_adjust_mode_option(auto_adjust_raw)|
|`_resolve_default_postprocess`|fn|priv|1633-1675|def _resolve_default_postprocess(enable_luminance, lumina...|
|`_parse_run_options`|fn|priv|1676-1875|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|2262-2300|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|2301-2331|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|2332-2389|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_resolve_thumbnail_transpose_map`|fn|priv|2390-2421|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|2422-2444|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|2445-2446|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|2475-2517|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|2518-2651|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|2652-2657|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|2706-2720|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|2721-2737|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|2738-2756|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_write_bracket_images`|fn|priv|2757-2758|def _write_bracket_images(|
|`_order_bracket_paths`|fn|priv|2795-2820|def _order_bracket_paths(bracket_paths)|
|`_run_enfuse`|fn|priv|2821-2841|def _run_enfuse(bracket_paths, merged_tiff)|
|`_run_luminance_hdr_cli`|fn|priv|2842-2843|def _run_luminance_hdr_cli(|
|`_convert_compression_to_quality`|fn|priv|2887-2899|def _convert_compression_to_quality(jpg_compression)|
|`_resolve_imagemagick_command`|fn|priv|2900-2917|def _resolve_imagemagick_command()|
|`_resolve_auto_adjust_opencv_dependencies`|fn|priv|2918-2942|def _resolve_auto_adjust_opencv_dependencies()|
|`_to_uint8_image_array`|fn|priv|2943-2987|def _to_uint8_image_array(np_module, image_data)|
|`_clip_histogram_autolevel_channel`|fn|priv|2988-2989|def _clip_histogram_autolevel_channel(|
|`_apply_mean_gamma_correction_channel`|fn|priv|3021-3022|def _apply_mean_gamma_correction_channel(|
|`_apply_auto_brightness_rgb_uint8`|fn|priv|3049-3050|def _apply_auto_brightness_rgb_uint8(|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|3114-3115|def _apply_validated_auto_adjust_pipeline(|
|`_clamp01`|fn|priv|3196-3209|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|3210-3232|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|3233-3266|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|3267-3297|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|3298-3338|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|3339-3340|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|3389-3411|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|3412-3436|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|3427-3429|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|3437-3454|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|3455-3478|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|3479-3502|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|3503-3524|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline_opencv`|fn|priv|3525-3526|def _apply_validated_auto_adjust_pipeline_opencv(|
|`_load_piexif_dependency`|fn|priv|3605-3622|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|3623-3635|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|3815-3843|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|3844-3863|def _is_supported_runtime_os()|
|`run`|fn|pub|3864-4063|def run(args)|
