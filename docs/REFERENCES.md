...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L181-203)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L205-225)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L226-262)
...
### fn `def _border(left, middle, right)` `priv` (L246-248)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L249-252)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L263-279)
...
### fn `def print_help(version)` (L280-359)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L360-384)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L385-405)
...
### fn `def _parse_gamma_option(gamma_raw)` `priv` (L406-442)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L443-466)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L467-483)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L484-506)
...
### fn `def _resolve_default_postprocess(enable_luminance, luminance_tmo)` `priv` (L507-541)
...
### fn `def _parse_run_options(args)` `priv` (L542-741)
...
### fn `def _load_image_dependencies()` `priv` (L909-945)
...
### fn `def _build_exposure_multipliers(ev_value)` `priv` (L946-958)
...
### fn `def _write_bracket_images(raw_handle, imageio_module, multipliers, gamma_value, temp_dir)` `priv` (L959-992)
...
### fn `def _order_bracket_paths(bracket_paths)` `priv` (L993-1018)
...
### fn `def _run_enfuse(bracket_paths, merged_tiff)` `priv` (L1019-1039)
...
### fn `def _run_luminance_hdr_cli(bracket_paths, output_hdr_tiff, ev_value, luminance_options)` `priv` (L1040-1079)
...
### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L1080-1092)
...
|`PostprocessOptions`|class|pub|181-203|class PostprocessOptions|
|`LuminanceOptions`|class|pub|205-225|class LuminanceOptions|
|`_print_box_table`|fn|priv|226-262|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|246-248|def _border(left, middle, right)|
|`_line`|fn|priv|249-252|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|263-279|def _build_two_line_operator_rows(operator_entries)|
|`print_help`|fn|pub|280-359|def print_help(version)|
|`_parse_ev_option`|fn|priv|360-384|def _parse_ev_option(ev_raw)|
|`_parse_luminance_text_option`|fn|priv|385-405|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_gamma_option`|fn|priv|406-442|def _parse_gamma_option(gamma_raw)|
|`_parse_positive_float_option`|fn|priv|443-466|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|467-483|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|484-506|def _parse_jpg_compression_option(compression_raw)|
|`_resolve_default_postprocess`|fn|priv|507-541|def _resolve_default_postprocess(enable_luminance, lumina...|
|`_parse_run_options`|fn|priv|542-741|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|909-945|def _load_image_dependencies()|
|`_build_exposure_multipliers`|fn|priv|946-958|def _build_exposure_multipliers(ev_value)|
|`_write_bracket_images`|fn|priv|959-992|def _write_bracket_images(raw_handle, imageio_module, mul...|
|`_order_bracket_paths`|fn|priv|993-1018|def _order_bracket_paths(bracket_paths)|
