...
- var `DEFAULT_MAGIC_DENOISE_SIGMA_COLOR = 0.06` (L44)
- var `DEFAULT_MAGIC_DENOISE_SIGMA_SPACE = 4.0` (L45)
- var `DEFAULT_MAGIC_MICROCONTRAST_RADIUS = 10` (L46)
- var `DEFAULT_MAGIC_MICROCONTRAST_EPS = 1e-3` (L47)
- var `DEFAULT_MAGIC_MICROCONTRAST_AMOUNT = 0.14` (L48)
- var `DEFAULT_MAGIC_VIBRANCE_STRENGTH = 0.09` (L49)
- var `DEFAULT_MAGIC_SHARPEN_SIGMA = 1.0` (L50)
- var `DEFAULT_MAGIC_SHARPEN_AMOUNT = 0.28` (L51)
