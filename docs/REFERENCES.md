...
# dng2hdr2jpg.py | Python | 4224L | 137 symbols | 19 imports | 93 comments
...
- var `DEFAULT_LUMINANCE_HDR_MODEL = "debevec"` (L50)
- var `DEFAULT_LUMINANCE_HDR_WEIGHT = "flat"` (L51)
- var `DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE = "srgb"` (L52)
- var `DEFAULT_LUMINANCE_TMO = "mantiuk08"` (L53)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.25` (L54)
- var `DEFAULT_REINHARD02_CONTRAST = 0.85` (L55)
- var `DEFAULT_REINHARD02_SATURATION = 0.55` (L56)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.2` (L57)
- var `EV_STEP = 0.25` (L58)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L59)
- var `DEFAULT_DNG_BITS_PER_COLOR = 14` (L60)
- var `SUPPORTED_EV_VALUES = tuple(` (L61)
- var `AUTO_EV_LOW_PERCENTILE = 0.1` (L67)
- var `AUTO_EV_HIGH_PERCENTILE = 99.9` (L68)
- var `AUTO_EV_MEDIAN_PERCENTILE = 50.0` (L69)
- var `AUTO_EV_TARGET_SHADOW = 0.05` (L70)
- var `AUTO_EV_TARGET_HIGHLIGHT = 0.90` (L71)
- var `AUTO_EV_MEDIAN_TARGET = 0.5` (L72)
- var `AUTO_ZERO_SCENE_KEY_LOW_THRESHOLD = 0.35` (L73)
- var `AUTO_ZERO_SCENE_KEY_HIGH_THRESHOLD = 0.65` (L74)
- var `AUTO_ZERO_TARGET_LOW_KEY = 0.35` (L75)
- var `AUTO_ZERO_TARGET_HIGH_KEY = 0.65` (L76)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L250-277)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L279-291)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L293-323)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L325-345)
...
### class `class AutoEvInputs` `@dataclass(frozen=True)` (L347-374)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L375-411)
...
### fn `def _border(left, middle, right)` `priv` (L395-397)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L398-401)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L412-428)
...
### fn `def print_help(version)` (L429-612)
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L613-631)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L632-644)
...
### fn `def _derive_supported_ev_zero_values(base_max_ev)` `priv` (L645-661)
...
### fn `def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)` `priv` (L662-690)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L691-736)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L737-750)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L751-782)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L783-813)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L814-831)
...
### fn `def _parse_auto_zero_option(auto_zero_raw)` `priv` (L832-849)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L850-872)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L873-890)
...
### fn `def _clamp_ev_to_supported(ev_candidate, ev_values)` `priv` (L891-904)
...
### fn `def _quantize_ev_to_supported(ev_value, ev_values)` `priv` (L905-926)
...
### fn `def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)` `priv` (L927-948)
...
### fn `def _apply_auto_percentage_scaling(ev_value, percentage)` `priv` (L949-963)
...
### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L964-1023)
...
### fn `def _percentile(percentile_value)` `priv` (L998-1008)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L1024-1043)
...
### fn `def _derive_scene_key_preserving_median_target(p_median)` `priv` (L1044-1062)
...
### fn `def _optimize_auto_zero(auto_ev_inputs)` `priv` (L1063-1086)
...
### fn `def _optimize_adaptive_ev_delta(auto_ev_inputs)` `priv` (L1087-1116)
...
### fn `def _compute_auto_ev_value_from_stats(` `priv` (L1117-1122)

### fn `def _compute_auto_ev_value(raw_handle, supported_ev_values=None, ev_zero=0.0)` `priv` (L1150-1177)
...
### fn `def _resolve_ev_zero(` `priv` (L1178-1185)

### fn `def _resolve_ev_value(` `priv` (L1236-1243)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L1296-1316)
...
### fn `def _parse_gamma_option(gamma_raw)` `priv` (L1317-1353)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L1354-1377)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L1378-1394)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L1395-1417)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1418-1442)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L1443-1465)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1466-1491)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L1492-1515)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L1516-1622)
...
### fn `def _parse_auto_adjust_mode_option(auto_adjust_raw)` `priv` (L1623-1646)
...
### fn `def _resolve_default_postprocess(enable_luminance, luminance_tmo)` `priv` (L1647-1689)
...
### fn `def _parse_run_options(args)` `priv` (L1690-1889)
...
### fn `def _load_image_dependencies()` `priv` (L2325-2363)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L2364-2394)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L2395-2452)
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L2453-2484)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L2485-2507)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L2508-2509)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L2538-2580)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L2581-2714)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L2715-2720)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L2769-2783)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L2784-2800)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L2801-2819)
...
### fn `def _write_bracket_images(` `priv` (L2820-2821)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L2858-2883)
...
### fn `def _run_enfuse(bracket_paths, merged_tiff)` `priv` (L2884-2904)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L2905-2906)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L2958-2970)
...
### fn `def _resolve_imagemagick_command()` `priv` (L2971-2988)
...
### fn `def _resolve_auto_adjust_opencv_dependencies()` `priv` (L2989-3013)
...
### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L3014-3060)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L3061-3105)
...
### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L3106-3123)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L3124-3141)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L3142-3159)
...
### fn `def _apply_highlight_rolloff(np_module, linear_rgb)` `priv` (L3160-3178)
...
### fn `def _apply_auto_brightness_rgb_uint8(` `priv` (L3179-3180)

### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L3223-3224)
...
### fn `def _clamp01(np_module, values)` `priv` (L3305-3318)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L3319-3341)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L3342-3375)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L3376-3406)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L3407-3447)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L3448-3449)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L3498-3520)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L3521-3545)
...
### fn `def logistic(z_values)` (L3536-3538)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L3546-3563)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L3564-3587)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L3588-3611)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L3612-3633)
...
### fn `def _apply_validated_auto_adjust_pipeline_opencv(` `priv` (L3634-3635)

### fn `def _load_piexif_dependency()` `priv` (L3714-3731)
...
### fn `def _encode_jpg(` `priv` (L3732-3744)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L3952-3980)
...
### fn `def _is_supported_runtime_os()` `priv` (L3981-4000)
...
|`DEFAULT_LUMINANCE_HDR_MODEL`|var|pub|50||
|`DEFAULT_LUMINANCE_HDR_WEIGHT`|var|pub|51||
|`DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE`|var|pub|52||
|`DEFAULT_LUMINANCE_TMO`|var|pub|53||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|54||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|55||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|56||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|57||
|`EV_STEP`|var|pub|58||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|59||
|`DEFAULT_DNG_BITS_PER_COLOR`|var|pub|60||
|`SUPPORTED_EV_VALUES`|var|pub|61||
|`AUTO_EV_LOW_PERCENTILE`|var|pub|67||
|`AUTO_EV_HIGH_PERCENTILE`|var|pub|68||
|`AUTO_EV_MEDIAN_PERCENTILE`|var|pub|69||
|`AUTO_EV_TARGET_SHADOW`|var|pub|70||
|`AUTO_EV_TARGET_HIGHLIGHT`|var|pub|71||
|`AUTO_EV_MEDIAN_TARGET`|var|pub|72||
|`AUTO_ZERO_SCENE_KEY_LOW_THRESHOLD`|var|pub|73||
|`AUTO_ZERO_SCENE_KEY_HIGH_THRESHOLD`|var|pub|74||
|`AUTO_ZERO_TARGET_LOW_KEY`|var|pub|75||
|`AUTO_ZERO_TARGET_HIGH_KEY`|var|pub|76||
|`AutoAdjustOptions`|class|pub|250-277|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|279-291|class AutoBrightnessOptions|
|`PostprocessOptions`|class|pub|293-323|class PostprocessOptions|
|`LuminanceOptions`|class|pub|325-345|class LuminanceOptions|
|`AutoEvInputs`|class|pub|347-374|class AutoEvInputs|
|`_print_box_table`|fn|priv|375-411|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|395-397|def _border(left, middle, right)|
|`_line`|fn|priv|398-401|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|412-428|def _build_two_line_operator_rows(operator_entries)|
|`print_help`|fn|pub|429-612|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|613-631|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|632-644|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_zero_values`|fn|priv|645-661|def _derive_supported_ev_zero_values(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|662-690|def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)|
|`_detect_dng_bits_per_color`|fn|priv|691-736|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|737-750|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|751-782|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|783-813|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|814-831|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_auto_zero_option`|fn|priv|832-849|def _parse_auto_zero_option(auto_zero_raw)|
|`_parse_percentage_option`|fn|priv|850-872|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|873-890|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_clamp_ev_to_supported`|fn|priv|891-904|def _clamp_ev_to_supported(ev_candidate, ev_values)|
|`_quantize_ev_to_supported`|fn|priv|905-926|def _quantize_ev_to_supported(ev_value, ev_values)|
|`_quantize_ev_toward_zero_step`|fn|priv|927-948|def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)|
|`_apply_auto_percentage_scaling`|fn|priv|949-963|def _apply_auto_percentage_scaling(ev_value, percentage)|
|`_extract_normalized_preview_luminance_stats`|fn|priv|964-1023|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|998-1008|def _percentile(percentile_value)|
|`_coerce_positive_luminance`|fn|priv|1024-1043|def _coerce_positive_luminance(value, fallback)|
|`_derive_scene_key_preserving_median_target`|fn|priv|1044-1062|def _derive_scene_key_preserving_median_target(p_median)|
|`_optimize_auto_zero`|fn|priv|1063-1086|def _optimize_auto_zero(auto_ev_inputs)|
|`_optimize_adaptive_ev_delta`|fn|priv|1087-1116|def _optimize_adaptive_ev_delta(auto_ev_inputs)|
|`_compute_auto_ev_value_from_stats`|fn|priv|1117-1122|def _compute_auto_ev_value_from_stats(|
|`_compute_auto_ev_value`|fn|priv|1150-1177|def _compute_auto_ev_value(raw_handle, supported_ev_value...|
|`_resolve_ev_zero`|fn|priv|1178-1185|def _resolve_ev_zero(|
|`_resolve_ev_value`|fn|priv|1236-1243|def _resolve_ev_value(|
|`_parse_luminance_text_option`|fn|priv|1296-1316|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_gamma_option`|fn|priv|1317-1353|def _parse_gamma_option(gamma_raw)|
|`_parse_positive_float_option`|fn|priv|1354-1377|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|1378-1394|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|1395-1417|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|1418-1442|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|1443-1465|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|1466-1491|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_auto_brightness_options`|fn|priv|1492-1515|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_adjust_options`|fn|priv|1516-1622|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_auto_adjust_mode_option`|fn|priv|1623-1646|def _parse_auto_adjust_mode_option(auto_adjust_raw)|
|`_resolve_default_postprocess`|fn|priv|1647-1689|def _resolve_default_postprocess(enable_luminance, lumina...|
|`_parse_run_options`|fn|priv|1690-1889|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|2325-2363|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|2364-2394|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|2395-2452|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_resolve_thumbnail_transpose_map`|fn|priv|2453-2484|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|2485-2507|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|2508-2509|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|2538-2580|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|2581-2714|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|2715-2720|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|2769-2783|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|2784-2800|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|2801-2819|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_write_bracket_images`|fn|priv|2820-2821|def _write_bracket_images(|
|`_order_bracket_paths`|fn|priv|2858-2883|def _order_bracket_paths(bracket_paths)|
|`_run_enfuse`|fn|priv|2884-2904|def _run_enfuse(bracket_paths, merged_tiff)|
|`_run_luminance_hdr_cli`|fn|priv|2905-2906|def _run_luminance_hdr_cli(|
|`_convert_compression_to_quality`|fn|priv|2958-2970|def _convert_compression_to_quality(jpg_compression)|
|`_resolve_imagemagick_command`|fn|priv|2971-2988|def _resolve_imagemagick_command()|
|`_resolve_auto_adjust_opencv_dependencies`|fn|priv|2989-3013|def _resolve_auto_adjust_opencv_dependencies()|
|`_to_uint8_image_array`|fn|priv|3014-3060|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|3061-3105|def _to_uint16_image_array(np_module, image_data)|
|`_to_linear_srgb`|fn|priv|3106-3123|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|3124-3141|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|3142-3159|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_apply_highlight_rolloff`|fn|priv|3160-3178|def _apply_highlight_rolloff(np_module, linear_rgb)|
|`_apply_auto_brightness_rgb_uint8`|fn|priv|3179-3180|def _apply_auto_brightness_rgb_uint8(|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|3223-3224|def _apply_validated_auto_adjust_pipeline(|
|`_clamp01`|fn|priv|3305-3318|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|3319-3341|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|3342-3375|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|3376-3406|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|3407-3447|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|3448-3449|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|3498-3520|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|3521-3545|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|3536-3538|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|3546-3563|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|3564-3587|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|3588-3611|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|3612-3633|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline_opencv`|fn|priv|3634-3635|def _apply_validated_auto_adjust_pipeline_opencv(|
|`_load_piexif_dependency`|fn|priv|3714-3731|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|3732-3744|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|3952-3980|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|3981-4000|def _is_supported_runtime_os()|
|`run`|fn|pub|4001-4200|def run(args)|
