...
- `dng2hdr2jpg._apply_auto_brightness_rgb_uint8(...)`: Execute auto-brightness pre-stage pipeline (`histogram-clip autolevel -> CLAHE -> conditional gamma`) on luminance channel using scene-key-preserving target derivation before static postprocess factors [`src/shell_scripts/commands/dng2hdr2jpg.py`]
