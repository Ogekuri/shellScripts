...
- **REQ-070**: MUST render in `dng2hdr2jpg` help two box-drawing tables where the operators table uses two physical lines per operator row while preserving aligned Unicode borders and fixed column order.
