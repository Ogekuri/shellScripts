...
- **DES-005**: MUST apply a fixed 86400-second cooldown after version-check HTTP error responses.
...
- **REQ-061**: MUST print a bright-red error line and apply an 86400-second cooldown when the version-check HTTP request returns an HTTP error response.
